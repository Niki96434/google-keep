...
npm run dev
```
Чтобы запустить линтер используйте:
```
npm run lint:fix
```
...
## Кодстайл: правила eslint и базовое форматирование

- [.vscode/settings.json](https://) - общие настройки форматтера prettier и линтера для разных IDE
- [app/frontend/.prettierc](https://)
- [app/frontend/eslint.config.js](https://)
